      ...
      const mockConversations: Conversation[] = [
        {
          ...
          messages: [
            ...
            },
            {
              ...
              senderId: 'patient-1',
              senderName: 'You',
              content: 'Thank you! I\'m excited to meet you.',
            ...
            },
            {
              ...
              senderId: 'caregiver-1',
              senderName: 'Sarah Johnson',
              content: 'I\'ll be there at 2 PM as scheduled.',
        ...
        },
        {
          ...
          lastMessage: 'The meal prep went well today.',
          lastMessageTime: '2024-01-14T16:45:00Z',
          unreadCount: 0,
          messages: [
            {
              id: '4',
              senderId: 'caregiver-2',
              senderName: 'Michael Brown',
              content: 'The meal prep went well today.',
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-primary/80">Communicate with your caregivers</p>
          </div>
        </div>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            <h3 className="font-medium text-sm truncate">{conversation.caregiverName}</h3>
                  ...
                  <CardHeader className="border-b">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <CardTitle className="text-lg">{selectedConversation.caregiverName}</CardTitle>
