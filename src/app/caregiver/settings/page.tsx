          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure your caregiving business preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange('maxAppointmentsPerDay', parseInt(e.target.value) || 0)}
                      disabled={!isEditing}
                      placeholder="8"
                    />
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleInputChange('bookingRequests', checked)}
                    disabled={!isEditing}
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    <option value="patients">Visible to Patients Only</option>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Share your location for better matching</p>
                  </div>
                  <Switch
                    id="locationSharing"
