...
interface Notification {
  ...
  title: string;
  message: string;
  type: 'appointment' | 'message' | 'reminder' | 'system' | 'booking';
  isRead: boolean;
  timestamp: string;
    ...
    try {
      ...
      const mockNotifications: Notification[] = [
        ...
        },
        {
          ...
          message: 'You have an appointment with Mary Johnson in 1 hour',
          type: 'appointment',
          isRead: false,
        ...
        },
        {
          id: '3',
          title: 'New Message',
          message: 'You received a message from Robert Brown about your care plan',
          type: 'message',
          isRead: false,
        ...
        },
        {
          ...
          message: 'Payment for your services has been processed successfully',
          type: 'system',
          isRead: true,
        ...
        },
        {
          ...
          message: 'Your profile has been updated and is now live',
          type: 'system',
          isRead: true,
